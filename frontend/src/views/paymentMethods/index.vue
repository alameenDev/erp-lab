...
<script>
     ...
     export default {
          ...
          computed: {
               ...
               ...mapWritableState(usepaymentMethodstore, ["paymentMethods", "totalCount", "record", "dialog"]),
               filteredRecords() {
                    return this.paymentMethods.filter((record) => {
          ...
          methods: {
               ...mapActions(usepaymentMethodstore, ["GetpaymentMethods", "RemovepaymentMethod"]),
               deleteRecord(record) {
